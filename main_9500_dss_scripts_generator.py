# %%
import time
from Parser.parse_9500 import parse_all_data
...
from OpenDss.OpendssValidate_9500_id import run_opendss_validation,all_time_highest_discrepancy
...
# from rawData.test.dss_scripts.write_dss_scripts import create_opendss_scripts
...
if __name__ == "__main__":
    ...
    if ADMM:
        ...
        start_time = time.time()  # Start timing
        admmVals,admm_obj,admm_aug_obj,admm_conv = solve_ADMM(data, data_area, area_info, obj, rho=1e-2, max_iterations=500)
        end_time = time.time()  # End timing
    ...
    plot_voltage(copfVals = copfVals,opendssVals=opendssVals)
